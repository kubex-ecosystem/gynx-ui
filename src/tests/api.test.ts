...
// import { GromptAPI, APIError, isAPIError, GenerateResponse } from '@/services/api';
// import { useGromptAPI } from '@/hooks/useGromptAPI';
// import { MockInstance, MockResult, MockResultReturn } from 'vitest';
...
//       const mockFetch = await jest.mock(
//         '../services/api',
//         (): GenerateResponse => (
//           {
//             generatePrompt: {
